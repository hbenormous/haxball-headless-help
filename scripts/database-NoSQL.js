 ...
 * 
 * No exemplo asseguir vou mostrar como criar algo dentro do Indexed Database API usando o framework Dexie
 * 
...
room.onPlayerJoin = player => {
     ...
     */
    if (my) room.sendAnnouncement("Seus dados estão salvos!", player.id);
